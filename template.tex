...
\documentclass[
	...
	% vline=2.2em,
	  maincolor=Purple4,
	  sidecolor=Purple4!15!Gray!10,
	% sidetextcolor=green,
	  sectioncolor=Purple4,
	  subsectioncolor=Purple4!75,
...
\definecolor{basic}{HTML}{A07155}
\newcommand{\good}{Gold}
\newcommand{\medium}{Silver}
...
\cvaddress{Park Ave.~1,\newline 555 555 B-Woods}
% email address
...
\textcolor{maincolor}{\Large Programmiersprachen
	\vspace{2pt}
	 \hrule}	
	
	\begin{sidebarminipage}
		\chartlabel[\good]{Javascript}
		\chartlabel[\medium]{Python}
		\chartlabel[\medium]{Java/Groovy}
		\chartlabel[\medium]{SQL}
		\chartlabel[\basic]{C++}
	\end{sidebarminipage}
	
	\vspace{5px}
	\textcolor{maincolor}{\Large Tools
	\vspace{2pt}
	 \hrule}
	
	\begin{sidebarminipage}
		\chartlabel[\good]{HTML}
		\chartlabel[\good]{CSS}
		\chartlabel[\good]{Git}
		\chartlabel[\good]{npm}
		\chartlabel[\medium]{Linux}
		\chartlabel[\medium]{GNU Octave (MATLAB)}
		\chartlabel[\basic]{Webdriver}
		\chartlabel[\basic]{Geb}
		\chartlabel[\basic]{Spock}
	\end{sidebarminipage}
	...
	\begin{sidebarminipage}
		\chartlabel[PaleGreen1]{Accessebility}
		\chartlabel[PaleGreen1]{Scrum}
		\chartlabel[PaleGreen1]{with}
		\chartlabel[PaleGreen1]{proper}
		\chartlabel[PaleGreen1]{overflow}
		\chartlabel[PaleGreen1]{protection}
		\chartlabel[PaleGreen1]{for}
		\chartlabel[PaleGreen1]{labels}
	\end{sidebarminipage}
...
\graphicspath{{pics/flags/shiny/}}
	...
	\sidesection{Languages}	
		\pointskill{\flag{DE.png}}{Deutsch}{6}[6]
		\pointskill{\flag{GB.png}}{Englisch}{4}[6]
		\pointskill{\flag{FR.png}}{Französisch}{2}[6]
